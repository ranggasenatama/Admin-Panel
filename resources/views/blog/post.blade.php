    ...
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          ...
          <div class="clr"></div>
          <div class="comment"> <a href="#"><img src="blogtemplate/images/userpic.gif" width="40" height="40" alt="" class="userpic" /></a>
        ...
        <div class="article">
          ...
          <form action="#" method="post" id="leavereply">
            <ol>
              ...
              <li>
                <input type="image" name="imageField" id="imageField" src="blogtemplate/images/submit.gif" class="send" />
                <div class="clr"></div>
              </li>
            </ol>
          </form>
      ...
      <div class="sidebar">
        <div class="searchform">
          <form id="formsearch" name="formsearch" method="post" action="#">
            ...
            <input name="button_search" src="blogtemplate/images/search_btn.gif" class="button_search" type="image" />
          </form>
        </div>
        <div class="gadget">
