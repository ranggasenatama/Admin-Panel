...
@section('sidebar')
    @include('components.donatur.sidebar')
@endsection
...
@section('custom-css')
    ...
    <link rel="stylesheet" href="{{url('bower_components/adminbsb-materialdesign/plugins/fullcalendar/dist/fullcalendar.min.css')}}">
    <link rel="stylesheet" href="{{url('bower_components/adminbsb-materialdesign/plugins/fullcalendar/dist/fullcalendar.print.min.css')}}" media="print">
@endsection
@section('content')
...
<script src="{{url('bower_components/adminbsb-materialdesign/plugins/moment/moment.js')}}"></script>
<script src="{{url('bower_components/adminbsb-materialdesign/plugins/fullcalendar/dist/fullcalendar.min.js')}}"></script>
