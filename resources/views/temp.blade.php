            ...
            <div class="c6">
                <div class="row space-top">
                    <div class="c12 space-top">
                        <h1 class="maintitle ">
                            <span class="text-center">PENDAFTARAN SELESAI</span>
                        </h1>
                    </div>
                </div>
                <div class="space-bot">
                    <h2 class="title hometitlebg" style="background: #00cca3; height: 10px"></h2>
                    <div class="noshadowbox" style="padding: 40px">

                        <div class="simplebox">
                            <span class="title text-center" style="font-weight: 600; color: #000">Selamat Anda Terdaftar</span>
                            <br/>
                            <hr/>
                            <br/>
                            <ul class="text-left">
                                <li>Nama Pendaftaran : <b>Rohana Kudus</b>
                                </li>
                                <li>Pendidikan Asal : <b>Institut Teknologi 10 Nopember</b>
                                </li>
                                <li>Posisi yang dilamar : <b>Technician</b>
                                </li>
                                <hr/>
                            </ul>
                            <br/>
                            <ul class="custom-counter text-left">
                                <li>Terimakasih sudah mendaftar.
                                </li>
                                <li>Silahkan pantau terus website resmi untuk informasi rekruitment.
                                </li>
                                <li>Pengumuman penerimaan akan disampaikan maksimal sebulan setelah pendaftaran
                                </li>
                            </ul>
                        </div>
                        ...
                        <br/>
                        <br/>
                        <input type="submit" value="Kehalaman Utama"/>
                    </div>
                    <h2 class="title hometitlebg" style="background: #00cca3; height: 10px"></h2>
                </div>
            </div>
